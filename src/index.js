...
import PolicyAgreement from './components/section-components/policy-agreement';
...
import LegalAgreement from './components/legal-agreements';
        ...
        return(
                <HashRouter basename="/">
	                ...
	                <Switch>
                        ...
                        <Route path="/legalagreement" component={ LegalAgreement } />
                        <Route path="/policyagreement" component={ PolicyAgreement } />
...
const rootElement = document.getElementById('quarter'); // Replace with your root element
