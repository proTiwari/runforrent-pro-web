			...
			<div className="ltn__header-top-area section-bg-6 top-area-color-white---">
				...
				<div className="row">
					...
					<div className="ltn__top-bar-menu">
						<ul>
						<li><a href="mailto:team@runforrent.com?Subject=Flower%20greetings%20to%20you"><i className="icon-mail" /> team@runforrent.com</a></li>
						<li><a href="locations.html"><i className="icon-placeholder" /> user, current, address</a></li>
						</ul>
					</div>
					</div>
				...
				<div className="row">
					...
					<div className="site-logo-wrap">
						...
						<div className="get-support-info">
							<h6>Get Support</h6>
							<h4><a href="tel:+916306846970">+916306846970</a></h4>
						</div>
						</div>
					</div>
					</div>
